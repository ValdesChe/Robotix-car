...
public class BluetoothService {
    ...
    private static final UUID MY_APP_UUID = UUID.fromString(Constants.APP_UUID);

    //connect
    private final String SOCK_NAME = "secure";
     ...
     */
    private void connectionFailed(String errorMsg) {
        // Send a failure message back to the Activity
        Message msg = mHandler.obtainMessage(Constants.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(Constants.TOAST, "Unable to connect device" + errorMsg);
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    ...
    private class AcceptThread extends Thread {
        ...
        public AcceptThread() {
            ...
            try {
                tmp = mAdapter.listenUsingRfcommWithServiceRecord(SOCK_NAME, MY_APP_UUID);
